...
public class WatermarkTextDocumentWorker implements DocumentWorker {
  ...
  private void makeWatermarkText(Document doc, @SuppressWarnings("hiding") String watermarkText)
          throws Exception {
    ...
    for (Section sect : doc.getSections()) {
      // There could be up to three different headers in each section, since we
      // want
  ...
  private void insertWatermarkIntoHeader(Paragraph watermarkPara, Section sect, int headerType)
    ...
    if (header == null) {
      // There is no header of the specified type in the current section, create
      // it.
