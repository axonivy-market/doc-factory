...
public class ProduceDocumentWithSimpleReportTest extends DocFactoryTest {
  ...
  public void produceDocument_with_simple_tables() throws Exception {
    File template = new File(
            this.getClass().getResource("resources/template_with_simple_tables.docx").toURI().getPath());

    DocumentTemplate documentTemplate = DocumentTemplate.withTemplate(template)
            .putDataAsSourceForMailMerge(makeBeanWithCollection()).useLocale(Locale.forLanguageTag("de-CH"));
