...
public class AsposePdfFactoryTest {
	...
	public static void setupClass() throws URISyntaxException {
		try (InputStream licIn = AsposePdfFactoryTest.class.getResourceAsStream("resources/docfactory_2019_09_04.lic")) {
		...
		PDF_FILE = new java.io.File(AsposePdfFactoryTest.class.getResource("../resources/files/simplePDF.pdf").toURI().getPath());
	}
	...
	public void convertToPdfA_PDF_A_2B() throws DocFactoryException, IOException {
		...
		assertTrue(resultFile.isFile());
		// PDFBox cannot validate the PdfAType.PDF_A_2B result. But other online tools can.
		// Example: https://www.pdf-online.com/osa/validate.aspx can validate the result of this unit test.
		// We should in general be careful with PDF/A validation as it does not seem to be consistent across different tools.
		assertFalse(PdfAValidator.isPDFACompliant(resultFile));
	}
	...
	public void convertToPdfA_PDF_A_3B() throws DocFactoryException, IOException {
		...
		assertTrue(resultFile.isFile());
		// PDFBox cannot validate the PdfAType.PDF_A_3B result. But other online tools can.
		// Example: https://www.pdf-online.com/osa/validate.aspx can validate the result of this unit test.
		// We should in general be careful with PDF/A validation as it does not seem to be consistent across different tools.
		assertFalse(PdfAValidator.isPDFACompliant(resultFile));
	}
	...
	public void convertToPdfA_PDF_A_2U() throws DocFactoryException, IOException {
		...
		assertTrue(resultFile.isFile());
		// PDFBox cannot validate the PdfAType.PDF_A_2U result. But other online tools can.
		// Example: https://www.pdf-online.com/osa/validate.aspx can validate the result of this unit test.
		// We should in general be careful with PDF/A validation as it does not seem to be consistent across different tools.
		assertFalse(PdfAValidator.isPDFACompliant(resultFile));
	}
	...
	public void convertToPdfA_PDF_A_3U() throws DocFactoryException, IOException {
		...
		assertTrue(resultFile.isFile());
		// PDFBox cannot validate the PdfAType.PDF_A_3U result. But other online tools can.
		// Example: https://www.pdf-online.com/osa/validate.aspx can validate the result of this unit test.
		// We should in general be careful with PDF/A validation as it does not seem to be consistent across different tools.
		assertFalse(PdfAValidator.isPDFACompliant(resultFile));
	}
