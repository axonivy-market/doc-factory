...
public class AsposeDocumentAppenderTest {
	...
	public void setup() throws Exception {
		...
		Document doc1 = new Document(new File(this.getClass().getResource("../resources/files/document1.doc").toURI()).getAbsolutePath());
		Document doc2 = new Document(new File(this.getClass().getResource("../resources/files/document2.docx").toURI()).getAbsolutePath());
		Document doc3 = new Document(new File(this.getClass().getResource("../resources/files/another_doc.doc").toURI()).getAbsolutePath());
		documents.add(doc1);
		documents.add(doc2);
		documents.add(doc3);
		...
		//In this test we append all the documents as new page. Allowing us to count the result page count easily.
		fileAppenderOptions = FileAppenderOptions.getInstance().withDocumentAppendingStart(DocumentAppendingStart.NEW_PAGE);
	}
