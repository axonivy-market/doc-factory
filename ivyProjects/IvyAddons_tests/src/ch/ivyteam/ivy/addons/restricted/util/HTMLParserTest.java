...
public class HTMLParserTest {
	...
	public void stringWithoutTag_is_not_HTML() {
		assertFalse(HTMLParser.isHTML("Lupsem test in the dvbaid /n sdgh < //ggt < /> << >*& $ \\\\ ygbdfsdkj @me"));
	}
	...
	public void stringWithSelfEnclosingTag_is_HTML() {
		assertTrue(HTMLParser.isHTML("Lupsem test in the <br /> dvbaid /n sdgh < //ggt < /> << >*& $ \\\\ ygbdfsdkj @me"));
	}
	
	@Test
	public void stringWithNoEnclosingTag_is_not_HTML() {
		assertFalse(HTMLParser.isHTML("Lupsem test in the <br> dvbaid /n sdgh < //ggt < /> << >*& $ \\\\ ygbdfsdkj @me"));
	}
