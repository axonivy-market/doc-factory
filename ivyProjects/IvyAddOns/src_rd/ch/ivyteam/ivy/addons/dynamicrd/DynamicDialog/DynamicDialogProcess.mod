...
Ds0 @RichDialogInitStart f3 '' #zField
...
Ds0 @RichDialogInitStart f5 '' #zField
...
Ds0 @RichDialogProcessStep f27 '' #zField
Ds0 @PushWFArc f28 '' #zField
Ds0 @PushWFArc f24 '' #zField
Ds0 @RichDialogMethodStart f115 '' #zField
Ds0 @RichDialogProcessEnd f118 '' #zField
Ds0 @RichDialogMethodStart f114 '' #zField
Ds0 @RichDialogProcessEnd f117 '' #zField
Ds0 @RichDialogMethodStart f116 '' #zField
Ds0 @RichDialogProcessEnd f119 '' #zField
...
Ds0 @Alternative f43 '' #zField
Ds0 @RichDialogProcessEnd f45 '' #zField
Ds0 @RichDialog f49 '' #zField
Ds0 @PushWFArc f46 '' #zField
Ds0 @RichDialogProcessStep f51 '' #zField
...
Ds0 @RichDialogProcessStep f59 '' #zField
...
Ds0 @PushWFArc f106 '' #zField
Ds0 @PushWFArc f107 '' #zField
Ds0 @RichDialogInitStart f109 '' #zField
Ds0 @PushWFArc f108 '' #zField
Ds0 @RichDialogMethodStart f110 '' #zField
Ds0 @RichDialogProcessStep f111 '' #zField
Ds0 @RichDialogProcessEnd f112 '' #zField
Ds0 @PushWFArc f113 '' #zField
Ds0 @PushWFArc f123 '' #zField
Ds0 @RichDialogProcessStep f124 '' #zField
Ds0 @PushWFArc f126 '' #zField
Ds0 @PushWFArc f13 '' #zField
Ds0 @PushWFArc f19 '' #zField
Ds0 @RichDialogProcessStart f125 '' #zField
Ds0 @RichDialogProcessEnd f127 '' #zField
Ds0 @PushWFArc f128 '' #zField
Ds0 @RichDialog f129 '' #zField
Ds0 @RichDialogProcessEnd f130 '' #zField
Ds0 @RichDialogMethodStart f131 '' #zField
Ds0 @RichDialogProcessStep f132 '' #zField
Ds0 @PushWFArc f133 '' #zField
...
Ds0 f3 disableUIEvents true #txt
...
<java.lang.Object value,List<java.lang.String> cmsContext> param = methodEvent.getInputArguments();
' #txt
Ds0 f3 inParameterMapAction 'out.cmsContext=param.cmsContext;
out.value=param.value;
' #txt
Ds0 f3 outParameterDecl '<java.lang.String result,ch.ivyteam.ivy.scripting.objects.CompositeObject object> result;
' #txt
Ds0 f3 outParameterMapAction 'result.result=in.result;
...
Ds0 f7 222 238 20 20 13 0 #rect
Ds0 f7 @|RichDialogProcessEndIcon #fIcon
Ds0 f9 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f9 actionTable 'out=in;
' #txt
Ds0 f9 actionCode 'import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.KnownParameters;
...
String cacheId;
ch.ivyteam.ivy.data.cache.IDataCacheEntry entry;
DynamicDialogCacheEntry ddEntry;
Number cacheLifeTime;

cacheLifeTime = Cms.coAsNumber(Cms.getCmsContexts(in.cmsContext).add(0,"/" + in.value.getClass().getName().replace(".", "/")), KnownParameters.CACHE_LIFE_TIME_PARAMETER, 0);

if (cacheLifeTime != 0)
{
	cacheId = in.value.getClass().getName();
	if (ivy.session.getActiveEnvironment().equals(""))
	{
		cacheId += ivy.session.getActiveEnvironment();
	}
	if (in.cmsContext.size() > 0)
	{ 
	...
	if (entry != null)
	{
		ddEntry = entry.getValue() as DynamicDialogCacheEntry;	
	
		if (in.cmsContext is initialized && !ddEntry.getCmsContexts() is initialized)
		{
			ddEntry = null;
		}
		if (in.cmsContext is initialized && ddEntry.getCmsContexts() is initialized && !ddEntry.getCmsContexts().equals(in.cmsContext))
		{
			ddEntry = null;
		}
		if (in.#classMap is initialized && !ddEntry.getClassMap() is initialized)
		{
			ddEntry = null;
		}
		if (in.#classMap is initialized && ddEntry.getClassMap() is initialized && !ddEntry.getClassMap().equals(in.classMap))
		{
			ddEntry = null;
		}
		if (#ddEntry is initialized)
		{
			ivy.log.debug("DD - Get from cache - " + cacheId);
		}
	}
}
...
if (! #ddEntry is initialized)
{
	ddEntry = DynamicDialogPanel.constructParameters(in.value.getClass(), in.cmsContext, in.dbConfig, null, in.classMap);
}
if (cacheLifeTime != 0)
{
...
<elementInfo>
    <language>
        <name>Constructs parameters or gets from cache
Start DD</name>
        <nameStyle>41,7,9
8,7,9
</nameStyle>
...
<> param = methodEvent.getInputArguments();
' #txt
Ds0 f14 outParameterDecl '<java.lang.Object value> result;
' #txt
...
<java.lang.Object value> param = methodEvent.getInputArguments();
' #txt
Ds0 f15 inParameterMapAction 'out.value=param.value;
' #txt
Ds0 f15 outParameterDecl '<> result;
' #txt
Ds0 f15 outActionCode 'if (in.isInitialized)
{
	panel.setDDValue(in.value);
}' #txt
...
Ds0 f16 638 238 20 20 13 0 #rect
Ds0 f16 @|RichDialogProcessEndIcon #fIcon
Ds0 f17 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f17 782 238 20 20 13 0 #rect
...
Ds0 f5 disableUIEvents true #txt
...
' #txt
Ds0 f5 inParameterMapAction 'out.cmsContext=param.cmsContext;
out.value=param.object;
' #txt
Ds0 f5 outParameterDecl '<java.lang.String result,ch.ivyteam.ivy.scripting.objects.CompositeObject object> result;
' #txt
Ds0 f5 outParameterMapAction 'result.result=in.result;
...
' #txt
Ds0 f12 inParameterMapAction 'out.xmlFile=param.fileName;
' #txt
...
<java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f18 inParameterMapAction 'out.fullName=param.fullName;
' #txt
Ds0 f18 outParameterDecl '<ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.Component component> result;
' #txt
...
<java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f20 inParameterMapAction 'out.fullName=param.fullName;
' #txt
...
Ds0 f21 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f21 950 454 20 20 13 0 #rect
Ds0 f21 @|RichDialogProcessEndIcon #fIcon
Ds0 f22 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f22 1102 454 20 20 13 0 #rect
Ds0 f22 @|RichDialogProcessEndIcon #fIcon
Ds0 f25 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f25 actionTable 'out=in;
' #txt
Ds0 f25 actionCode 'out.component = panel.getDDComponent(in.fullName);' #txt
Ds0 f25 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f25 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language/>
</elementInfo>
' #txt
Ds0 f25 942 380 36 24 20 -2 #rect
Ds0 f25 @|RichDialogProcessStepIcon #fIcon
Ds0 f26 expr out #txt
Ds0 f26 960 338 960 380 #arcP
Ds0 f23 expr out #txt
Ds0 f23 960 404 960 454 #arcP
Ds0 f27 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f27 actionTable 'out=in;
' #txt
Ds0 f27 actionCode 'out.fieldComponent = panel.getDDFieldComponent(in.fullName);' #txt
Ds0 f27 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f27 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language/>
</elementInfo>
' #txt
Ds0 f27 1094 380 36 24 20 -2 #rect
Ds0 f27 @|RichDialogProcessStepIcon #fIcon
...
Ds0 f115 disableUIEvents false #txt
Ds0 f115 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
...
Ds0 f114 disableUIEvents false #txt
Ds0 f114 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
Ds0 f114 outParameterDecl '<java.lang.Boolean result> result;
' #txt
...
Ds0 f116 disableUIEvents false #txt
Ds0 f116 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
...
Ds0 f119 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f119 1118 646 20 20 13 0 #rect
Ds0 f119 @|RichDialogProcessEndIcon #fIcon
Ds0 f120 expr out #txt
Ds0 f120 960 546 960 646 #arcP
...
Ds0 f30 1206 646 20 20 13 0 #rect
...
<java.lang.String dataclassFullName,ch.ivyteam.ivy.scripting.objects.CompositeObject object,ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.StaticRelation staticRelation> param = methodEvent.getInputArguments();
' #txt
Ds0 f32 inParameterMapAction 'out.fullName=param.dataclassFullName;
out.staticRelation=param.staticRelation;
out.value=param.object;
' #txt
Ds0 f32 outParameterDecl '<java.lang.String result,ch.ivyteam.ivy.scripting.objects.CompositeObject object> result;
' #txt
Ds0 f32 outParameterMapAction 'result.result=in.result;
result.object=panel.getValue() as CompositeObject;
' #txt
...
Ds0 f33 46 486 20 20 13 0 #rect
Ds0 f33 @|RichDialogProcessEndIcon #fIcon
Ds0 f34 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
...
Ds0 f45 1422 422 20 20 13 0 #rect
Ds0 f45 @|RichDialogProcessEndIcon #fIcon
Ds0 f49 targetDisplay TOP #txt
Ds0 f49 richDialogId ch.ivyteam.ivy.addons.commondialogs.MessageDialog #txt
Ds0 f49 startMethod showMessage(String) #txt
Ds0 f49 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f49 requestActionDecl '<String message> param;' #txt
Ds0 f49 requestMappingAction 'param.message=in.messageText;
' #txt
Ds0 f49 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f49 responseMappingAction 'out=in;
' #txt
Ds0 f49 windowConfiguration '{/title "<%=in.messageTitle%>"/width 0 /height 0 /centered true /resizable false /maximized false /close_after_last_rd true }' #txt
Ds0 f49 isAsynch false #txt
Ds0 f49 isInnerRd true #txt
Ds0 f49 isDialog true #txt
Ds0 f49 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Display modal dialog</name>
        <nameStyle>20,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f49 1518 364 36 24 20 -2 #rect
Ds0 f49 @|RichDialogIcon #fIcon
Ds0 f46 expr out #txt
Ds0 f46 1518 386 1440 427 #arcP
Ds0 f51 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f51 actionTable 'out=in;
out.messageText=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/validationDialogMessage");
out.messageTitle=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/validationDialogTitle");
' #txt
Ds0 f51 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f51 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Set message and title</name>
        <nameStyle>21,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f51 1518 300 36 24 20 -2 #rect
...
<ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogPanel dd,java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f53 inParameterMapAction 'out.result="cancel";
' #txt
...
<ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogPanel dd,java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f38 inParameterMapAction 'out.result="close";
' #txt
...
<ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogPanel dd,java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f44 inParameterMapAction 'out.result="ok";
' #txt
...
<ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogPanel dd,java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
Ds0 f55 inParameterMapAction 'out.result="validateAndClose";
' #txt
...
Ds0 f47 expr in #txt
Ds0 f47 1446 264 1536 300 #arcP
Ds0 f47 1 1536 264 #addKink
Ds0 f47 0 0.7331051323142665 0 0 #arcLabel
Ds0 f48 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f48 actionTable 'out=in;
out.result=panel.#dDMethodParameter is initialized ? panel.dDMethodParameter : in.result;
' #txt
Ds0 f48 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f48 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>set result value</name>
        <nameStyle>16,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f48 1414 212 36 24 20 -2 #rect
Ds0 f48 @|RichDialogProcessStepIcon #fIcon
Ds0 f52 expr out #txt
Ds0 f52 1450 192 1439 212 #arcP
Ds0 f57 expr out #txt
Ds0 f57 1432 236 1432 250 #arcP
Ds0 f59 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f59 actionTable 'out=in;
out.result=panel.#dDMethodParameter is initialized ? panel.dDMethodParameter : in.result;
' #txt
Ds0 f59 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
...
' #txt
Ds0 f59 1286 148 36 24 20 -2 #rect
Ds0 f59 @|RichDialogProcessStepIcon #fIcon
Ds0 f61 expr out #txt
Ds0 f61 1322 128 1311 148 #arcP
Ds0 f62 expr out #txt
Ds0 f62 1432 162 1432 212 #arcP
Ds0 f37 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f37 actionTable 'out=in;
' #txt
Ds0 f37 actionCode panel.closeButton.doClick(); #txt
Ds0 f37 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f37 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>force closeEvent UI Event</name>
        <nameStyle>25,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f37 1414 324 36 24 -138 21 #rect
Ds0 f37 @|RichDialogProcessStepIcon #fIcon
Ds0 f54 expr in #txt
Ds0 f54 outCond panel.isValid() #txt
Ds0 f54 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>yes</name>
        <nameStyle>3,9
...
' #txt
Ds0 f54 1432 278 1432 324 #arcP
Ds0 f54 0 0.11764705882352941 13 0 #arcLabel
Ds0 f58 expr out #txt
Ds0 f58 1432 348 1432 422 #arcP
Ds0 f60 expr out #txt
Ds0 f60 1304 172 1414 336 #arcP
Ds0 f60 1 1304 336 #addKink
Ds0 f60 0 0.9368720231383051 0 0 #arcLabel
Ds0 f42 guid 127212CB786FD078 #txt
Ds0 f42 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f42 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
...
' #txt
Ds0 f42 1758 70 20 20 13 0 #rect
Ds0 f42 @|RichDialogProcessStartIcon #fIcon
Ds0 f65 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f65 guid 127212CC30FED491 #txt
Ds0 f65 1758 134 20 20 13 0 #rect
Ds0 f65 @|RichDialogEndIcon #fIcon
Ds0 f66 expr out #txt
Ds0 f66 1768 90 1768 134 #arcP
Ds0 f41 expr out #txt
Ds0 f41 1304 98 1304 148 #arcP
Ds0 f39 guid 12722DE87C4B2D45 #txt
Ds0 f39 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f39 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f39 actionTable 'out=in;
' #txt
Ds0 f39 actionCode panel.reload(); #txt
...
' #txt
Ds0 f39 1758 198 20 20 13 0 #rect
Ds0 f39 @|RichDialogProcessStartIcon #fIcon
Ds0 f40 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f40 1758 254 20 20 13 0 #rect
Ds0 f40 @|RichDialogProcessEndIcon #fIcon
Ds0 f56 expr out #txt
Ds0 f56 1768 218 1768 254 #arcP
...
Ds0 f71 disableUIEvents false #txt
Ds0 f71 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
...
Ds0 f70 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f70 1182 910 20 20 13 0 #rect
Ds0 f70 @|RichDialogProcessEndIcon #fIcon
Ds0 f74 targetDisplay TOP #txt
Ds0 f74 richDialogId ch.ivyteam.ivy.addons.commondialogs.QuestionDialog #txt
Ds0 f74 startMethod askQuestion(String,String,List<String>,String) #txt
Ds0 f74 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f74 requestActionDecl '<String icon, String question, List<String> buttons, String defaultButton> param;' #txt
Ds0 f74 requestMappingAction 'param.icon="question";
param.question=in.messageText;
param.buttons=["yes", "no"];
param.defaultButton="yes";
' #txt
Ds0 f74 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f74 responseMappingAction 'out=in;
out.answer=result.pressedButton;
' #txt
Ds0 f74 windowConfiguration '{/title "<%=in.messageTitle%>"/width 0 /height 0 /centered true /resizable false /maximized false /close_after_last_rd true }' #txt
...
<elementInfo>
    <language>
        <name>Display the confirmation dialog</name>
        <nameStyle>31,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f74 1174 796 36 24 20 -2 #rect
Ds0 f74 @|RichDialogIcon #fIcon
Ds0 f78 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f78 actionTable 'out=in;
' #txt
Ds0 f78 actionCode 'import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.Component;
import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.Table;

Component component;
Table table;

component = panel.getComponent(in.fullName);

if (component instanceof Table)
{
	table = component as Table;
	
	table.removeSelectedListEntry();
}


' #txt
Ds0 f78 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f78 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Remove the line</name>
        <nameStyle>15,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f78 1174 868 36 24 21 -7 #rect
Ds0 f78 @|RichDialogProcessStepIcon #fIcon
Ds0 f76 expr out #txt
Ds0 f76 1192 892 1192 910 #arcP
Ds0 f80 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f80 actionTable 'out=in;
out.messageText=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/deleteEntryMessage");
out.messageTitle=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/deleteEntryTitle");
' #txt
Ds0 f80 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f80 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Prepare the dialog</name>
        <nameStyle>18,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f80 1174 748 36 24 20 -2 #rect
Ds0 f80 @|RichDialogProcessStepIcon #fIcon
...
Ds0 f83 1192 820 1192 826 #arcP
Ds0 f79 expr in #txt
Ds0 f79 outCond in.answer.equals("yes") #txt
Ds0 f79 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>yes</name>
        <nameStyle>3,7,9
...
' #txt
Ds0 f79 1192 854 1192 868 #arcP
Ds0 f79 0 0.21428571428571427 13 0 #arcLabel
Ds0 f84 expr in #txt
...
Ds0 f72 disableUIEvents false #txt
Ds0 f72 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<> param = methodEvent.getInputArguments();
' #txt
...
Ds0 f73 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f73 actionTable 'out=in;
out.messageText=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryEditingMessage");
out.messageTitle=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryEditingTitle");
' #txt
Ds0 f73 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
...
' #txt
Ds0 f73 942 756 36 24 20 -2 #rect
Ds0 f73 @|RichDialogProcessStepIcon #fIcon
Ds0 f77 expr out #txt
Ds0 f77 960 730 960 756 #arcP
Ds0 f85 targetDisplay TOP #txt
Ds0 f85 richDialogId ch.ivyteam.ivy.addons.commondialogs.MessageDialog #txt
Ds0 f85 startMethod showMessage(String) #txt
Ds0 f85 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f85 requestActionDecl '<String message> param;' #txt
Ds0 f85 requestMappingAction 'param.message=in.messageText;
' #txt
Ds0 f85 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f85 responseMappingAction 'out=in;
' #txt
Ds0 f85 windowConfiguration '{/title "<%=in.messageTitle%>"/width 0 /height 0 /centered true /resizable false /maximized false /close_after_last_rd true }' #txt
Ds0 f85 isAsynch false #txt
Ds0 f85 isInnerRd true #txt
Ds0 f85 isDialog true #txt
...
' #txt
Ds0 f85 942 804 36 24 20 -2 #rect
Ds0 f85 @|RichDialogIcon #fIcon
Ds0 f86 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f86 950 854 20 20 13 0 #rect
...
<elementInfo>
    <language>
        <name>blockedValidationMessage()</name>
        <nameStyle>26,5,7,9
</nameStyle>
    </language>
</elementInfo>
...
Ds0 f90 disableUIEvents false #txt
Ds0 f90 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<java.lang.String fullName> param = methodEvent.getInputArguments();
' #txt
...
Ds0 f92 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f92 requestActionDecl '<String message> param;' #txt
Ds0 f92 requestMappingAction 'param.message=in.messageText;
' #txt
Ds0 f92 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
...
' #txt
Ds0 f92 958 1036 36 24 20 -2 #rect
Ds0 f92 @|RichDialogIcon #fIcon
Ds0 f93 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f93 actionTable 'out=in;
out.messageText=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryBlockedValidationMessage");
out.messageTitle=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryBlockedValidationTitle");
' #txt
Ds0 f93 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
...
' #txt
Ds0 f93 958 988 36 24 20 -2 #rect
Ds0 f93 @|RichDialogProcessStepIcon #fIcon
Ds0 f94 expr out #txt
Ds0 f94 976 1012 976 1036 #arcP
...
Ds0 f97 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f97 requestActionDecl '<String icon, String question, List<String> buttons, String defaultButton> param;' #txt
Ds0 f97 requestMappingAction 'param.icon="question";
param.question=in.messageText;
param.buttons=["yes", "no"];
param.defaultButton="yes";
' #txt
Ds0 f97 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f97 responseMappingAction 'out=in;
out.answer=result.pressedButton;
' #txt
Ds0 f97 windowConfiguration '{/title "<%=in.messageTitle%>"/width 0 /height 0 /centered true /resizable false /maximized false /close_after_last_rd true }' #txt
...
Ds0 f99 1270 1142 20 20 13 0 #rect
Ds0 f99 @|RichDialogProcessEndIcon #fIcon
Ds0 f100 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f100 actionTable 'out=in;
' #txt
Ds0 f100 actionCode 'import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.Component;
import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.MasterDetail;
...
if (component instanceof MasterDetail)
{
	table = component as MasterDetail;
...
' #txt
Ds0 f100 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f100 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Save the entry</name>
        <nameStyle>14,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f100 1262 1100 36 24 21 -7 #rect
Ds0 f100 @|RichDialogProcessStepIcon #fIcon
Ds0 f101 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f101 actionTable 'out=in;
out.messageText=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryValidationMessage");
out.messageTitle=ivy.cms.co("/ch/ivyteam/ivy/addons/dynamicrd/DynamicDialog/plainStrings/entryValidationTitle");
' #txt
Ds0 f101 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
...
' #txt
Ds0 f101 1262 980 36 24 20 -2 #rect
Ds0 f101 @|RichDialogProcessStepIcon #fIcon
Ds0 f102 expr out #txt
Ds0 f102 1280 1124 1280 1142 #arcP
Ds0 f103 expr out #txt
Ds0 f103 1280 1004 1280 1028 #arcP
Ds0 f104 expr out #txt
Ds0 f104 1280 1052 1280 1058 #arcP
Ds0 f105 expr in #txt
Ds0 f105 outCond in.answer.equals("yes") #txt
Ds0 f105 .xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>yes</name>
        <nameStyle>3,7,9
...
' #txt
Ds0 f105 1280 1086 1280 1100 #arcP
Ds0 f105 0 0.42857142857142855 11 0 #arcLabel
Ds0 f106 expr in #txt
Ds0 f106 1273 1079 1274 1143 #arcP
Ds0 f106 1 1248 1104 #addKink
...
Ds0 f109 disableUIEvents true #txt
Ds0 f109 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<ch.ivyteam.ivy.scripting.objects.CompositeObject object,List<java.lang.String> cmsContext,java.util.Map classMap> param = methodEvent.getInputArguments();
' #txt
Ds0 f109 inParameterMapAction 'out.classMap=param.classMap;
out.cmsContext=param.cmsContext;
out.value=param.object;
' #txt
Ds0 f109 outParameterDecl '<java.lang.String result,ch.ivyteam.ivy.scripting.objects.CompositeObject object> result;
' #txt
Ds0 f109 outParameterMapAction 'result.result=in.result;
result.object=panel.getValue() as CompositeObject;
' #txt
...
Ds0 f111 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f111 actionTable 'out=in;
' #txt
Ds0 f111 actionCode 'ch.ivyteam.ivy.data.cache.IDataCacheGroup group;

group = ivy.datacache.getApplicationCache().getGroup("DynamicDialog");
if (#group is initialized)
{
	ivy.datacache.getApplicationCache().invalidateGroup(group);
}' #txt
Ds0 f111 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f111 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language/>
</elementInfo>
' #txt
Ds0 f111 1510 580 36 24 20 -2 #rect
Ds0 f111 @|RichDialogProcessStepIcon #fIcon
Ds0 f112 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f112 1518 654 20 20 13 0 #rect
Ds0 f112 @|RichDialogProcessEndIcon #fIcon
Ds0 f113 expr out #txt
Ds0 f113 1528 538 1528 580 #arcP
Ds0 f123 expr out #txt
Ds0 f123 1528 604 1528 654 #arcP
Ds0 f124 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f124 actionTable 'out=in;
' #txt
Ds0 f124 actionCode 'import ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.SerializeXML;

SerializeXML serializer;

serializer = SerializeXML.getNewInstance();
serializer.serializeXML(panel.getDDValue(),
	panel.getParameterTree());
serializer.saveDocument(in.xmlFile);' #txt
Ds0 f124 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f124 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Serialize content</name>
        <nameStyle>17,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f124 966 148 36 24 20 -2 #rect
Ds0 f124 @|RichDialogProcessStepIcon #fIcon
Ds0 f126 expr out #txt
Ds0 f126 984 101 984 148 #arcP
Ds0 f13 expr out #txt
Ds0 f13 984 172 984 238 #arcP
Ds0 f19 expr out #txt
Ds0 f19 792 101 792 238 #arcP
Ds0 f125 guid 12EB38839FCDF28F #txt
Ds0 f125 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f125 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f125 actionTable 'out=in;
' #txt
Ds0 f125 actionCode 'out.isInitialized = true;
panel.onLoad(in.value);' #txt
...
' #txt
Ds0 f125 1758 310 20 20 13 0 #rect
Ds0 f125 @|RichDialogProcessStartIcon #fIcon
Ds0 f127 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f127 1758 382 20 20 13 0 #rect
Ds0 f127 @|RichDialogProcessEndIcon #fIcon
Ds0 f128 expr out #txt
Ds0 f128 1768 330 1768 382 #arcP
Ds0 f129 targetWindow THIS #txt
Ds0 f129 targetDisplay EXISTING:<%=in.controllerDisplayName%> #txt
Ds0 f129 richDialogId IvyScript://in.controllerName #txt
Ds0 f129 startMethod start() #txt
Ds0 f129 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f129 requestActionDecl '<> param;' #txt
Ds0 f129 responseActionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f129 responseMappingAction 'out=in;
' #txt
Ds0 f129 windowConfiguration '* ' #txt
Ds0 f129 isAsynch true #txt
Ds0 f129 isInnerRd true #txt
Ds0 f129 isDialog false #txt
Ds0 f129 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Load the controller</name>
        <nameStyle>19,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f129 1102 196 36 24 20 -2 #rect
Ds0 f129 @|RichDialogIcon #fIcon
Ds0 f130 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f130 1110 238 20 20 13 0 #rect
Ds0 f130 @|RichDialogProcessEndIcon #fIcon
Ds0 f131 guid 12EB38C9B4063B53 #txt
Ds0 f131 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f131 method loadController(String) #txt
Ds0 f131 disableUIEvents false #txt
Ds0 f131 inParameterDecl 'ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent methodEvent = event as ch.ivyteam.ivy.richdialog.exec.RdMethodCallEvent;
<java.lang.String controllerName> param = methodEvent.getInputArguments();
' #txt
Ds0 f131 inParameterMapAction 'out.controllerName=param.controllerName;
' #txt
Ds0 f131 outParameterDecl '<> result;
' #txt
...
' #txt
Ds0 f131 1110 126 20 20 13 0 #rect
Ds0 f131 @|RichDialogMethodStartIcon #fIcon
Ds0 f132 actionDecl 'ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData out;
' #txt
Ds0 f132 actionTable 'out=in;
' #txt
Ds0 f132 actionCode 'out.controllerDisplayName = panel.getControllerDisplayName();' #txt
Ds0 f132 type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
Ds0 f132 @C|.xml '<?xml version="1.0" encoding="UTF-8" standalone="yes"?>
<elementInfo>
    <language>
        <name>Get display name</name>
        <nameStyle>16,7,9
</nameStyle>
    </language>
</elementInfo>
' #txt
Ds0 f132 1102 156 36 24 20 -2 #rect
Ds0 f132 @|RichDialogProcessStepIcon #fIcon
Ds0 f133 expr out #txt
Ds0 f133 1120 220 1120 238 #arcP
Ds0 f134 expr out #txt
Ds0 f134 1120 146 1120 156 #arcP
Ds0 f135 expr out #txt
Ds0 f135 1120 180 1120 196 #arcP
...
methods</swimlaneLabel>
    ...
    <swimlaneSize>515</swimlaneSize>
    <swimlaneSize>401</swimlaneSize>
    <swimlaneSize>814</swimlaneSize>
...
' #txt
>Proto Ds0 .type ch.ivyteam.ivy.addons.dynamicrd.DynamicDialog.DynamicDialogData #txt
...
Ds0 f9 mainOut f4 tail #connect
Ds0 f4 head f7 mainIn #connect
Ds0 f14 mainOut f6 tail #connect
Ds0 f6 head f16 mainIn #connect
Ds0 f5 mainOut f8 tail #connect
Ds0 f8 head f9 mainIn #connect
Ds0 f18 mainOut f26 tail #connect
Ds0 f26 head f25 mainIn #connect
Ds0 f25 mainOut f23 tail #connect
Ds0 f23 head f21 mainIn #connect
Ds0 f20 mainOut f28 tail #connect
Ds0 f28 head f27 mainIn #connect
Ds0 f27 mainOut f24 tail #connect
Ds0 f24 head f22 mainIn #connect
Ds0 f116 mainOut f120 tail #connect
Ds0 f120 head f117 mainIn #connect
Ds0 f114 mainOut f121 tail #connect
Ds0 f121 head f118 mainIn #connect
Ds0 f115 mainOut f122 tail #connect
Ds0 f122 head f119 mainIn #connect
...
Ds0 f49 mainOut f46 tail #connect
Ds0 f46 head f45 mainIn #connect
Ds0 f51 mainOut f50 tail #connect
Ds0 f50 head f49 mainIn #connect
Ds0 f47 head f51 mainIn #connect
Ds0 f55 mainOut f52 tail #connect
Ds0 f52 head f48 mainIn #connect
Ds0 f48 mainOut f57 tail #connect
Ds0 f57 head f43 in #connect
Ds0 f38 mainOut f61 tail #connect
Ds0 f61 head f59 mainIn #connect
Ds0 f44 mainOut f62 tail #connect
Ds0 f62 head f48 mainIn #connect
Ds0 f43 out f54 tail #connect
Ds0 f54 head f37 mainIn #connect
Ds0 f43 out f47 tail #connect
Ds0 f37 mainOut f58 tail #connect
Ds0 f58 head f45 mainIn #connect
Ds0 f59 mainOut f60 tail #connect
Ds0 f60 head f37 mainIn #connect
Ds0 f42 mainOut f66 tail #connect
Ds0 f66 head f65 mainIn #connect
Ds0 f53 mainOut f41 tail #connect
Ds0 f41 head f59 mainIn #connect
Ds0 f39 mainOut f56 tail #connect
Ds0 f56 head f40 mainIn #connect
Ds0 f78 mainOut f76 tail #connect
Ds0 f76 head f70 mainIn #connect
Ds0 f71 mainOut f81 tail #connect
Ds0 f81 head f80 mainIn #connect
Ds0 f80 mainOut f75 tail #connect
Ds0 f75 head f74 mainIn #connect
Ds0 f74 mainOut f83 tail #connect
Ds0 f83 head f82 in #connect
Ds0 f82 out f79 tail #connect
Ds0 f79 head f78 mainIn #connect
Ds0 f82 out f84 tail #connect
Ds0 f84 head f70 mainIn #connect
Ds0 f72 mainOut f77 tail #connect
Ds0 f77 head f73 mainIn #connect
Ds0 f73 mainOut f87 tail #connect
Ds0 f87 head f85 mainIn #connect
Ds0 f85 mainOut f88 tail #connect
Ds0 f88 head f86 mainIn #connect
Ds0 f93 mainOut f94 tail #connect
Ds0 f94 head f92 mainIn #connect
Ds0 f92 mainOut f95 tail #connect
Ds0 f95 head f91 mainIn #connect
Ds0 f89 mainOut f96 tail #connect
Ds0 f96 head f93 mainIn #connect
Ds0 f100 mainOut f102 tail #connect
Ds0 f102 head f99 mainIn #connect
Ds0 f101 mainOut f103 tail #connect
Ds0 f103 head f97 mainIn #connect
Ds0 f97 mainOut f104 tail #connect
Ds0 f104 head f98 in #connect
Ds0 f98 out f105 tail #connect
Ds0 f105 head f100 mainIn #connect
Ds0 f98 out f106 tail #connect
Ds0 f106 head f99 mainIn #connect
Ds0 f90 mainOut f107 tail #connect
Ds0 f107 head f101 mainIn #connect
Ds0 f109 mainOut f108 tail #connect
Ds0 f108 head f9 mainIn #connect
Ds0 f110 mainOut f113 tail #connect
Ds0 f113 head f111 mainIn #connect
Ds0 f111 mainOut f123 tail #connect
Ds0 f123 head f112 mainIn #connect
Ds0 f12 mainOut f126 tail #connect
Ds0 f126 head f124 mainIn #connect
Ds0 f124 mainOut f13 tail #connect
Ds0 f13 head f11 mainIn #connect
Ds0 f15 mainOut f19 tail #connect
Ds0 f19 head f17 mainIn #connect
Ds0 f125 mainOut f128 tail #connect
Ds0 f128 head f127 mainIn #connect
Ds0 f129 mainOut f133 tail #connect
Ds0 f133 head f130 mainIn #connect
Ds0 f131 mainOut f134 tail #connect
Ds0 f134 head f132 mainIn #connect
Ds0 f132 mainOut f135 tail #connect
Ds0 f135 head f129 mainIn #connect
