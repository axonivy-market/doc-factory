...
private RTable getTable() {
	if (Table == null) {
		...
		Table.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons false /version \"3.0\"/emptyTableText \"No versions / Keine Versionen vorhanden / Aucune version\"/columns {{/result \"result=entry.versionNumber\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileVersioning/plainStrings/versionnumber\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.filename\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/fileName\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.user\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileVersioning/plainStrings/creationUser\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.date.format(\\\"dd.MM.yyyy\\\")\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/creationDate\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}{/result \"result=entry.time.format(\\\"HH:mm:ss\\\")\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/creationTime\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/cellWidget \"\"}}}");
