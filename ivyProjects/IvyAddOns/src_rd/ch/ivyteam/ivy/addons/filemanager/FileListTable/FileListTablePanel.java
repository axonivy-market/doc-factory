...
private RTable getFileListTable() {
	if (fileListTable == null) {
		...
		fileListTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons true /version \"3.0\"/emptyTableText \"Keine Datei / Aucun Fichier / No File\"/columns {{/result \"result=entry.filename\"/version \"3.0\"/tooltip \"\"/icon \"result=IF(entry instanceof ch.ivyteam.ivy.addons.filemanager.database.filelink.FileLink,\\r\\n\\tivy.cms.cr(\\\"/ch/ivyteam/ivy/addons/icons/filelink/16\\\"),\\r\\n\\tIF(!entry.locked.trim().equals(\\\"1\\\"),null,\\r\\n\\tivy.cms.cr(\\\"/ch/ivyteam/ivy/addons/icons/lock/16\\\"))\\r\\n)\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/fileName\\\")\"/headerAlignment \"default\"/field \"\"/condition \"\"/columnWidth \"250\"}{/result \"result=IF(\\r\\nentry instanceof ch.ivyteam.ivy.addons.filemanager.database.filelink.FileLink,\\r\\n(entry as ch.ivyteam.ivy.addons.filemanager.database.filelink.FileLink).linkCreationDate.toIvyDate().format(\\\"dd-MM-yyyy\\\"),\\r\\nentry.creationDate.toIvyDate().format(\\\"dd-MM-yyyy\\\")\\r\\n)\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/creationDate\\\")\"/headerAlignment \"default\"/field \"\"/condition \"\"/columnWidth \"150\"}{/result \"result=entry.userID\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/createdBy\\\")\"/headerAlignment \"default\"/field \"\"/columnWidth \"80\"}}}");
