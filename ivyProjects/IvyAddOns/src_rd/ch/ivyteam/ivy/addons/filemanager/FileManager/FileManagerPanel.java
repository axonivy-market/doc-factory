...
{ 
	...
	protected RTree getOrdnersTree() {
		if (ordnersTree == null) {
			...
			ordnersTree.setModelConfiguration("{/dynamicTreeLoadMode \"LOAD_FOR_RENDER_PARENT\"/version \"3.0\"/showTableheader true /autoTableheader false /showtooltip false /showIcons true /emptyTableText \"\"/columns {{/patterns {{/result \"result=\\\"Folder\\\"\"/version \"3.0\"/icon \"result=ivy.cms.cr(\\\"/ch/ivyteam/ivy/addons/icons/folder/16\\\")\"/patternMode \"ALL\"/patternValue \"default\"}{/result \"result=IF(entry.displayName.isEmpty(),entry.name,entry.displayName)\"/version \"3.0\"/tooltip \"\"/icon \"result=ivy.cms.cr(\\\"/ch/ivyteam/ivy/addons/icons/square/16\\\")\"/patternMode \"INSTANCE\"/patternValue \"ch.ivyteam.ivy.addons.filemanager.LockedFolder\"}{/result \"result=IF(entry.displayName.isEmpty(),entry.name,entry.displayName)\"/version \"3.0\"/icon \"\"/patternMode \"INSTANCE\"/patternValue \"ch.ivyteam.ivy.addons.filemanager.FolderOnServer\"}}/version \"3.0\"}}}");
		...
		if (transferHandler == null) {
			transferHandler = new TransferHandler() {
				...
				public boolean importData(ULCComponent arg0, Transferable _transferable) {
					...
					{
						java.util.List<?> dvalues = DnDUtils.getDroppedTransferData(_transferable);
						if(!dvalues.isEmpty()) {
							if(dvalues.get(0) instanceof FolderOnServer) {
								FolderOnServer fos = (FolderOnServer) dvalues.get(0);
								newPath=fos.getPath();
							}
						}
					...
					if(newPath!=null)
					{
						...
						{//We try to select the destination Tree
							...
							RDCallbackMethodHandler.callRDMethod(panel, "selectFolderOnServer", new Object[] {newPath});
							RDCallbackMethodHandler.callRDMethod(panel, "uploadFiles", param);
							b=true;
	...
	protected RPopupMenu getServerDirPopupMenu() {
		if (ServerDirPopupMenu == null) {
			...
			ServerDirPopupMenu.add(getTranslateDirMenuItem());
		}
	...
	protected RButton getUnlockButton() {
		if (unlockButton == null) {
			...
			unlockButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsTop \"2\"/insetsBottom \"1\"/insetsRight \"0\"/fill \"HORIZONTAL\"/insetsLeft \"1\"/weightX \"1\"}");
	...
	protected RButton getDownloadButton() {
		if (downloadButton == null) {
			...
			downloadButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsTop \"2\"/insetsBottom \"1\"/insetsRight \"0\"/fill \"HORIZONTAL\"/insetsLeft \"1\"/weightX \"1\"}");
	...
	protected RButton getEditButton() {
		if (editButton == null) {
			...
			editButton.setStyleProperties("{/anchor \"CENTER\"/insetsTop \"2\"/insetsLeft \"0\"}");
	...
	protected RButton getNewCopyButton() {
		if (newCopyButton == null) {
			...
			newCopyButton.setStyleProperties("{/insetsLeft \"1\"/insetsRight \"0\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/marginLeft \"1\"/insetsTop \"2\"/insetsBottom \"1\"/horizontalAlignment \"LEFT\"/weightX \"1\"/fill \"HORIZONTAL\"}");
	...
	protected RButton getDeleteButton() {
		if (deleteButton == null) {
			...
			deleteButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsTop \"0\"/insetsBottom \"0\"/insetsRight \"0\"/fill \"HORIZONTAL\"/insetsLeft \"1\"}");
	...
	protected RButton getRefreshSelectedFolderButton() {
		if (refreshSelectedFolderButton == null) {
			...
			refreshSelectedFolderButton.setStyleProperties("{/insetsLeft \"1\"/insetsRight \"0\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsTop \"0\"/insetsBottom \"0\"/horizontalAlignment \"LEFT\"/fill \"HORIZONTAL\"}");
	...
	protected RButton getPrintButton() {
		if (printButton == null) {
			...
			printButton.setStyleProperties("{/anchor \"CENTER\"/insetsTop \"2\"/insetsLeft \"0\"}");
	...
	protected RButton getMakeNewDirButton() {
		if (makeNewDirButton == null) {
			...
			makeNewDirButton.setStyleProperties("{/anchor \"CENTER\"/insetsTop \"2\"/fill \"NONE\"/insetsLeft \"0\"/weightX \"0\"}");
	...
	protected RButton getDeleteDirButton() {
		if (deleteDirButton == null) {
			...
			deleteDirButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/marginLeft \"1\"/fill \"HORIZONTAL\"/insetsLeft \"1\"}");
	...
	protected RGridBagLayoutPane getGridBagLayoutPane() {
		if (GridBagLayoutPane == null) {
			...
			GridBagLayoutPane.setName("GridBagLayoutPane");
			GridBagLayoutPane.add(getToolbarGridBagLayoutPane(), new com.ulcjava.base.application.GridBagConstraints(0, 0, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
			GridBagLayoutPane.add(getFileActionsToolBar2BoxPane(), new com.ulcjava.base.application.GridBagConstraints(0, 1, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
	...
	protected RButton getRefreshDirsButton() {
		if (refreshDirsButton == null) {
			...
			refreshDirsButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/fill \"NONE\"/insetsLeft \"1\"}");
	...
	protected RButton getDownloadAllFilesButton() {
		if (downloadAllFilesButton == null) {
			...
			downloadAllFilesButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsBottom \"1\"/insetsTop \"2\"/fill \"HORIZONTAL\"/insetsLeft \"1\"}");
	...
	protected RButton getToogleFileListingButton() {
		if (toogleFileListingButton == null) {
			...
			toogleFileListingButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/insetsBottom \"1\"/insetsTop \"2\"/insetsLeft \"1\"}");
	...
	protected RButton getPasteButton() {
		if (pasteButton == null) {
			...
			pasteButton.setStyleProperties("{/horizontalAlignment \"LEFT\"/font \"name=Tahoma\\nsize=10\\nstyle=PLAIN\"/insetsTop \"0\"/insetsBottom \"0\"/insetsRight \"0\"/fill \"HORIZONTAL\"/insetsLeft \"1\"}");
	...
	protected RGridBagLayoutPane getFileToolbarPane() {
		if (fileToolbarPane == null) {
			...
			fileToolbarPane.setStyleProperties("{/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			/*if(this.xpertlineLF){
				fileToolbarPane.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			}*/
	...
	protected RGridBagLayoutPane getFileToolbarPane2() {
		if (fileToolbarPane2 == null) {
			...
			fileToolbarPane2.setStyleProperties("{/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			/*if(this.xpertlineLF){
				fileToolbarPane2.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			}*/
	...
	protected RGridBagLayoutPane getFileToolbarPane3() {
		if (fileToolbarPane3 == null) {
			...
			fileToolbarPane3.setStyleProperties("{/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			/*if(this.xpertlineLF){
			fileToolbarPane3.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
		}*/
	...
	protected RGridBagLayoutPane getFilesGridBagLayoutPane() {
		if (filesGridBagLayoutPane == null) {
			...
			filesGridBagLayoutPane.setName("filesGridBagLayoutPane");
			filesGridBagLayoutPane.add(getFilesTableScrollPane(), new com.ulcjava.base.application.GridBagConstraints(0, 0, 1, 1, -1, -1, com.ulcjava.base.application.GridBagConstraints.CENTER, com.ulcjava.base.application.GridBagConstraints.NONE, new com.ulcjava.base.application.util.Insets(0,0,0,0), 0, 0));
		}
	...
	protected RGridBagLayoutPane getToolbarGridBagLayoutPane() {
		if (toolbarGridBagLayoutPane == null) {
			...
			toolbarGridBagLayoutPane.setStyleProperties("{/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
			/*if(this.xpertlineLF){
			toolbarGridBagLayoutPane.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
		}*/
			toolbarGridBagLayoutPane.setName("toolbarGridBagLayoutPane");
	...
	protected RButton getUploadButton() {
		if (uploadButton == null) {
			...
			uploadButton.setStyleProperties("{/insetsTop \"2\"}");
	...
	protected RGridBagLayoutPane getButtonsGridBagLayoutPane() {
		if (buttonsGridBagLayoutPane == null) {
			...
			/*if(this.xpertlineLF){
			buttonsGridBagLayoutPane.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"EAST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
		}*/
			buttonsGridBagLayoutPane.setName("buttonsGridBagLayoutPane");
	...
	protected RGridBagLayoutPane getButtonGroupGridBagLayoutPane() {
		if (buttonGroupGridBagLayoutPane == null) {
			...
			/*if(this.xpertlineLF){
			buttonGroupGridBagLayoutPane.setStyleProperties("{/backgroundColor \"b=0\\ng=0\\nr=0\"/anchor \"WEST\"/fill \"HORIZONTAL\"/weightX \"1\"}");
		}*/
	...
	protected RBoxPane getFileActionsToolBar2BoxPane() {
		if (fileActionsToolBar2BoxPane == null) {
			...
			fileActionsToolBar2BoxPane.setStyleProperties("{/fill \"HORIZONTAL\"/weightX \"1\"}");
			fileActionsToolBar2BoxPane.setName("fileActionsToolBar2BoxPane");
	...
	/**
	 * This method initializes makeVersionMenuItem	
	 * 	
	 * @return ch.ivyteam.ivy.richdialog.widgets.menus.RMenuItem	
	 */
	...
	/**
	 * This method initializes openVersionsMenuItem	
	 * 	
	 * @return ch.ivyteam.ivy.richdialog.widgets.menus.RMenuItem	
	 */
	...
	/**
	 * This method initializes translateDirMenuItem	
	 * 	
	 * @return ch.ivyteam.ivy.richdialog.widgets.menus.RMenuItem	
	 */
	protected RMenuItem getTranslateDirMenuItem() {
		if (translateDirMenuItem == null) {
			...
			translateDirMenuItem.setText("<%=ivy.cms.co(\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/buttonLabels/translateDir\")%>");
			translateDirMenuItem.setIconUri("<%=ivy.cms.cr(\"/ch/ivyteam/ivy/addons/icons/marker/16\")%>");
