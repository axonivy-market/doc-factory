...
/**
 * 
 * This class is an abstract helper class that implements the FileActionListener, FileTypeActionListener,
 *  FileTagActionListener, FileVersionActionListener interfaces.<br>
 ...
 * @author ec
 */
public abstract class AbstractFileActionListener implements FileActionListener, FileTypeActionListener,
	FileTagActionListener, FileVersionActionListener{
	...
	/* FROM FileVersionActionListener */
	@Override
