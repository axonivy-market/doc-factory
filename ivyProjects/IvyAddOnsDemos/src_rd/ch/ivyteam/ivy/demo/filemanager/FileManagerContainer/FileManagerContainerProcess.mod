[Ivy]
[>Created: Mon May 28 10:10:53 EDT 2012]
...
' #txt
Fs0 f3 embeddedRdInitializations '{/fileManagerPanel {/fieldName "fileManagerPanel"/startMethod "startWithConfigInGlobalVariables(String)"/parameterMapping "param.serverPath=callParam.serverPath;\n"/initScript ""/userContext * }}' #txt
