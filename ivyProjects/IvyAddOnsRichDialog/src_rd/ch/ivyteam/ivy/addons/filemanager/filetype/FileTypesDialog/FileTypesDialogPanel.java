...
{ 
	...
	private RTable getFileTypesTable() {
		if (fileTypesTable == null) {
			...
			fileTypesTable.setModelConfiguration("{/showTableheader true /autoTableheader false /showtooltip false /showIcons false /version \"3.0\"/emptyTableText \"No FileTypes / Keine Dateintypen / Aucun type de documents\"/columns {{/result \"result=entry.displayName\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/name\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/columnStyle \"default\"/cellWidget \"\"}{/result \"result=IF(entry.#applicationName==null,\\\"\\\",entry.applicationName)\"/version \"3.0\"/tooltip \"\"/icon \"\"/header \"ivy.cms.co(\\\"/ch/ivyteam/ivy/addons/filemanager/fileManagement/tableStrings/applicationName\\\")\"/headerAlignment \"default\"/field \"\"/editable \"\"/condition \"\"/columnStyle \"default\"/cellWidget \"\"}}}");
