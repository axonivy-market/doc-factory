...
public class DocumentTemplateWithCleanupOptionsTest extends DocFactoryTest {
	...
	public void documentTemplate_has_default_cleanupOptions_byDefault() throws URISyntaxException {
		...
		assertThat(simpleMergeCleanupOptions, equalTo(SimpleMergeCleanupOptions.getRecommendedMergeCleanupOptionsForSimpleMerging()));
		...
		MergeCleanupOptions mergeCleanupOptions = documentTemplate.getDocumentFactory().getRegionsMergeCleanupOptions();
		
		assertThat(mergeCleanupOptions, equalTo(MergeCleanupOptions.getRecommendedMergeCleanupOptionsForMergingWithRegions()));
	...
	public void withSimpleMergeCleanupOptions_changes_the_cleanupOptions_for_simple_merging() throws URISyntaxException {
		...
		assertThat(simpleMergeCleanupOptions, not(SimpleMergeCleanupOptions.getRecommendedMergeCleanupOptionsForSimpleMerging()));
	...
	public void withRegionsMergeCleanupOptions_changes_the_cleanupOptions_for_simple_merging() throws URISyntaxException {
		...
		MergeCleanupOptions changedMergeCleanupOptions = new MergeCleanupOptions().
				removingBlankLines(false).
				removingEmptyParagraphs(false).
				removingUnusedRegions(false).
				removingContainingFields(false).
		...
		assertThat(mergeCleanupOptions, not(MergeCleanupOptions.getRecommendedMergeCleanupOptionsForMergingWithRegions()));
	...
	public void produceDocument_by_default_removes_lines_with_only_empty_string_values() throws URISyntaxException {
		...
		DocumentTemplate documentTemplate = DocumentTemplate.
				withTemplate(template).
				putDataAsSourceForSimpleMailMerge(p).
