...
/**
 * A DocumentWorker can be injected in an AsposeDocFactory for applying some
 * custom logic on the com.aspose.words.Document generated by the mail merge
 * with a template. Please read the com.aspose.words.Document API from Aspose
 * (https://www.aspose.com/products/words/java).<br>
...
public interface DocumentWorker {
   ...
   *
   * @param document the aspose document upon which the mail merge has been
   ...
   * @param generatedFile the file which has been generated. In this method you
   *          will have some actions on this file.
   * @return the File that the docFactory should return after your logic has
   *         been performed. In a lot of cases you will simply return the file
   *         that has been passed as parameter and on which you have applied
   *         your logic. In some cases you may want to return another file
   *         resulting of your logic.<br />
