 ...
 * @author ec<br>
 * @since 27.10.2009<br>
 *        This class containc utils static methods that helps java.io.File
 *        manipulation
 */
public final class FileUtil {

  /**
   * Formats a given path in a path with the right system File.separator
   * characters<br>
   ...
   * Formats a given path in a path with the right system File.separator
   * characters<br>
   * It checks if there is a File.separator at the end of the path. If not it
   * adds one.<br>
   ...
   * It checks if there is a File.separator at the end of the path. If not it
   * adds one.<br>
   * If the boolean argument is true, it checks if the directory exists and
   * creates it if it doesn't exist.
   * @param path : the path to format with the right end file separator
   * @param createDirIfNotExits boolean telling if has to check for the
   *          directory existence
   * @return formatted path with the system File.separator
   */
  ...
  /**
   * Returns all the File from a directory whose name is composed by the String
   * p and the given String pattern pat.<br>
   * It is very useful to find the images that are included in an HTML file.<br>
   * For example, if a HTML file named test.html contains test.001.jpeg and
   * test.002.jpeg,<br>
   * it is easy to list those images with getFilesWithPattern("\\.[0-9].*$",
   * "test", "")<br>
   * Of course the name of the images included in the file must follow the given
   * pattern.
