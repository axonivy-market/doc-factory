 ...
 * @author ec<br>
 * @since 27.10.2009<br>
 * @see TemplateMergeFieldType
 *      ch.ivyteam.ivy.addons.docfactory.TemplateMergeFieldType
 */
public class TemplateMergeField {
  ...
  /**
   * Creates a new TemplateMergeField with the given name. The Name will be used
   * in the mail merging operation for filling the corresponding mail merge
  ...
  /**
   * Set the Type {@link TemplateMergeFieldType} and the value of this
   * TemplateMergeField.<br>
   * If you don't want to care about setting the type yourself, use
   * {@link TemplateMergeField#withValue(Object)} or
   * {@link TemplateMergeField#asSimpleValue(Object)}. An introspection is done
   * for getting children TemplateMergeFields in case of an Object or a
   * Collection type. This allows supporting mail merge with regions or nested
   * regions.
   * @param fieldType the TemplateMergeFieldType reflecting the type of this
   ...
   * An introspection is done for getting children TemplateMergeFields in case
   * of an Object or a Collection type. This allows supporting mail merge with
   * regions or nested regions. The {@link TemplateMergeFieldType} will be
  ...
  /**
   * Set the value of the TemplateMergeField and return it.<br>
   * The {@link TemplateMergeFieldType} will be automatically computed. The
   * resulting TemplateMergeField won't be used for introspection to look if it
   * contains collection of data for mail merge with regions.
   * @param val the value to set, cannot be null.
   */
   ...
   * ....)
   * @return true if the TemplateMergeField value is from type
   *         {@link TemplateMergeFieldType#COLLECTION}
   */
  ...
  private void makeChildren() {
    ...
    if (this.type.is(TemplateMergeFieldType.COLLECTION)) {
      for (Collection<TemplateMergeField> result : MergeFieldsExtractor
              .getMergeFieldsForCollectionTemplateMergeField(this.getMergeFieldName(), this)) {
  ...
  /**
   * returns the value to be used for mail merging. In case of Date or Number
   * type, it returns the formatted String of the Date or Number. Else it
