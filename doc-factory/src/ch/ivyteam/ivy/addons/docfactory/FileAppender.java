...
public abstract class FileAppender {
  ...
  /**
   * Filter the office files (doc, docx, odt) from the given File list and
   * return them in a List.
   * @param files the file List to be filtered. Cannot be null.
   * @return The List of office files (doc, docx, odt) contained in the original
   *         File List.
   */
  ...
  /**
   * Appends the given pdf files together and produces a File with the options
   * set in the
   * {@link ch.ivyteam.ivy.addons.docfactory.options.MultipleDocumentsCreationOptions}.
   * All non pdf files will be ignored.
   * @param filesToAppendTogether the List of Pdf java.io.File to be appended.
   *          The first File will be the first part of the produced document,
   *          the second one will be the second part ... Cannot be null or
   *          empty. All non pdf files will be ignored.
   * @return the produced file
   * @throws Exception
   */
  public abstract File appendPdfFiles(List<File> filesToAppendTogether,
          FileAppenderOptions fileAppenderOptions) throws Exception;

  /**
   * Appends the given office (doc, docx, odt) files together and produces a
   * File with the options set in the
   * {@link ch.ivyteam.ivy.addons.docfactory.options.MultipleDocumentsCreationOptions}.
   * All non office (doc, docx, odt) files will be ignored.
   * @param filesToAppendTogether the List of office (doc, docx, odt)
   *          java.io.File to be appended. The first File will be the first part
   *          of the produced document, the second one will be the second part
   *          ... Cannot be null or empty. All non office (doc, docx, odt) files
   *          will be ignored.
   * @return the produced file
   * @throws Exception
   */
  public abstract File appendOfficeWordFiles(List<File> filesToAppendTogether,
          FileAppenderOptions fileAppenderOptions) throws Exception;
