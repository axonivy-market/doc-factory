...
public class MailMergeDataSourceGeneratorTest {
	...
	@Test
	public void getFromCollectionTypeTemplateMergeField_returns_null_if_templateMergeField_not_Collection_Type() throws Exception {
	...
	@Test
	public void getFromCollectionTypeTemplateMergeField_CollectionOfString_returns_IMailMergeDataSource() throws Exception {
		...
		for (@SuppressWarnings("unused") String string : hobbies) {
	...
	@Test
	public void getFromCollectionTypeTemplateMergeField_MapOfString_returns_IMailMergeDataSource() throws Exception {
		...
		IMailMergeDataSource  mmds = MailMergeDataSourceGenerator.getFromCollectionTypeTemplateMergeField(tmf);
		assertThat(mmds.getTableName(), org.hamcrest.CoreMatchers.equalTo("myHobbies"));
		for (@SuppressWarnings("unused") String string : hobbies.values()) {
			assertTrue(mmds.moveNext());
		}
	}
	
	@Test
	public void getFromCollectionTypeTemplateMergeField_CollectionOfBeans_returns_IMailMergeDataSource() throws Exception {
		...
		for (@SuppressWarnings("unused") Person p : persons) {
			assertTrue(mmds.moveNext());
		}
	}
	
	@Test
	public void getFromCollectionTypeTemplateMergeField_MapOfTemplateMergeField_returns_IMailMergeDataSource() throws Exception {
		
		Map<Integer, Person> persons = new HashMap<>();
		persons.put(1, Person.withName("Andersson").withBirthday(Calendar.getInstance().getTime()).withICQ(4345634));
		persons.put(2, Person.withName("Andrea").withBirthday(Calendar.getInstance().getTime()).withICQ(87645645));
		...
		IMailMergeDataSource  mmds = MailMergeDataSourceGenerator.getFromCollectionTypeTemplateMergeField(tmf);
		assertThat(mmds.getTableName(), org.hamcrest.CoreMatchers.equalTo("myHobbies"));
		for (@SuppressWarnings("unused") Person p : persons.values()) {
			assertTrue(mmds.moveNext());
		}
	}
